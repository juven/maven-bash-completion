_mvn() 
{
    ...
    plugin_goals_versions="versions:commit|versions:compare-dependencies|versions:dependency-updates-report|versions:display-dependency-updates|versions:display-plugin-updates|versions:display-property-update|versions:help|versions:lock-snapshots|versions:plugin-updates-report|versions:property-updates-report|versions:resolve-ranges|versions:revert|versions:set|versions:unlock-snapshots|versions:update-child-modules|versions:update-parent|versions:update-properties|versions:update-property|versions:use-latest-releases|versions:use-latest-snapshots|versions:use-latest-releases|versions:use-next-releases|versions:use-next-snapshots|versions:use-next-versions|versions:use-releases"
