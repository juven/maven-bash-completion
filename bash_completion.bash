...
# on the command line: https://github.com/jrn looks to be the author
# of this code. As defined here https://github.com/git/git/blob/master/contrib/completion/git-completion.bash#L213
#
