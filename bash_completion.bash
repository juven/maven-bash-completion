...
_mvn()
{
    ...
    local plugin_goals_dbmaintain="dbmaintain:checkScriptUpdates|dbmaintain:markErrorScriptPerformed|dbmaintain:markErrorScriptReverted|dbmaintain:updateDatabase"
