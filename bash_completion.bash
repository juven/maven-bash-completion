...
_mvn()
{
    ...
    local plugin_goals_dbmaintain="dbmaintain:createScriptArchive|dbmaintain:updateDatabase|dbmaintain:markErrorScriptPerformed|dbmaintain:markErrorScriptReverted|dbmaintain:markDatabaseAsUpToDate|dbmaintain:checkScriptUpdates|dbmaintain:clearDatabase|dbmaintain:cleanDatabase|dbmaintain:disableConstraints|dbmaintain:updateSequences"
